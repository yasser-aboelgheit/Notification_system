...
from .celery_task import send_sms_on_register
import logging
...
class SelfRegisterViewSet(generics.CreateAPIView):
    ...
    def create(self, *args, **kwargs):
        ...
        passengerProfile = Passenger.objects.create(user=user,
                                                    ...
                                                    notification_langauge=serializer.validated_data["notification_langauge"],
                                                    active=True,
                                                    )
        send_sms_on_register.s(passengerProfile.name, passengerProfile.phone_number).apply_async(queue="tasks")
